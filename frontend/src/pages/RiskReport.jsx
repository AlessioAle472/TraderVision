      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-5">
          <button 
            ...
            className="p-3 rounded-2xl bg-slate-800/40 border border-white/5 hover:bg-slate-700/50 text-gray-400 hover:text-white transition-all cursor-pointer shadow-lg group"
          >
        ...
        <button 
          ...
          className="hidden md:flex items-center gap-2 px-6 py-3 rounded-2xl bg-blue-600/10 border border-blue-500/20 text-blue-400 hover:bg-blue-600 hover:text-white transition-all duration-300 font-black uppercase tracking-widest text-[10px]"
        >
