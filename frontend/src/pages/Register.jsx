...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background text-text font-inter">
      ...
      <div className="relative z-10 w-full max-w-md p-8 bg-surface/80 backdrop-blur-xl border border-slate-700/20 dark:border-slate-700 rounded-2xl shadow-2xl">
        ...
        <div className="mb-6 p-4 bg-amber-500/10 border border-amber-500/30 rounded-xl text-amber-600 dark:text-amber-400 text-sm">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                type="email"
                required
                className="w-full pl-10 pr-4 py-2 bg-background border border-slate-700/20 dark:border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-text transition"
