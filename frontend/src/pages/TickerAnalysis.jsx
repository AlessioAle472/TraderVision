...
const PillarBar = ({ label, value, max, color }) => {
  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="h-2.5 rounded-full bg-background overflow-hidden shadow-inner border border-border">
        <div
...
const TickerAnalysis = () => {
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 bg-surface rounded-3xl border border-border shadow-2xl p-8 max-w-md mx-auto mt-10 text-center">
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      {/* --- Header --- */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-surface p-6 rounded-3xl border border-border shadow-xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 relative z-10">
          <button onClick={() => navigate('/')} className="p-2.5 rounded-xl bg-surface-hover border border-border hover:border-primary/30 text-text-secondary hover:text-text transition-all shadow-md">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 space-y-6">
          ...
          <div className="bg-surface border border-border rounded-3xl overflow-hidden shadow-xl p-1 relative group">
             <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity pointer-events-none">
                <BarChart2 className="w-24 h-24 text-primary" />
             </div>
             <div className="px-5 pt-5 pb-2 flex justify-between items-center border-b border-border">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
             <div className="bg-surface p-5 rounded-3xl border border-border shadow-lg flex flex-col justify-between group hover:border-primary transition-colors">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-surface border border-border rounded-3xl p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              <div className={`mt-6 px-4 py-1.5 rounded-full border text-sm font-black uppercase tracking-widest ${scoreLabelColor} ${scoreLabelColor.replace('text-', 'bg-')}/10 ${scoreLabelColor.replace('text-', 'border-')}/20`}>
                {scoreLabel}
              </div>
            </div>
            ...
            {asset?.settore === 'FUTURE' && bd.macro_reason && (
              <div className={`mt-8 flex items-start gap-3 p-4 rounded-xl text-xs border ${bd.macro_reason.includes('Safe Haven') ? 'bg-amber-500/10 border-amber-500/25 text-amber-300' : 'bg-surface-hover border-border text-text-secondary'}`}>
