  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-background border border-slate-700/20 dark:border-slate-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary text-text transition-colors"
        ...
        {/* Master User Badge */}
        {user?.isMaster && (
          <section className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 p-6 rounded-2xl border border-amber-500/20">
