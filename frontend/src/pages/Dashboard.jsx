...
const Dashboard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
        <div className="space-y-3 flex-1">
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="group relative">
              <span className="px-3 py-1.5 rounded-full bg-orange-500/10 text-orange-500 border border-orange-500/20 text-xs font-black tracking-widest uppercase flex items-center gap-2 cursor-help shadow-lg shadow-orange-500/5">
              ...
              <div className="absolute left-0 top-full mt-2 w-64 p-3 bg-surface text-xs text-text-secondary rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-30 border border-border">
        ...
        <div className="flex items-center gap-4 w-full md:w-auto">
          <button 
            ...
            className="p-3 rounded-2xl bg-surface border border-border hover:border-primary/30 text-text-secondary hover:text-text transition-all shadow-xl group shrink-0"
            disabled={loading}
          >
      ...
      {/* Sticky KPI Bar */}
      <div className="sticky top-[64px] z-20 bg-background/95 backdrop-blur-md pt-2 pb-6 -mx-4 px-4 md:mx-0 md:px-0 transition-colors duration-300">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {loading && !overview ? (
            ...
            <>
              <div className="bg-surface p-6 rounded-2xl border border-border shadow-xl relative overflow-hidden group">
