...
const MacroDeepDive = () => {
 ...
 <button 
 onClick={() => navigate('/')} 
 className="p-3 rounded-2xl bg-slate-800/40 hover:bg-slate-700/50 text-gray-400 hover:text-white transition-all cursor-pointer shadow-lg"
 >
 ...
 <div className="bg-slate-900/40 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-2xl space-y-8">
 <div className="flex items-center justify-between">
 <div>
 ...
 <div className="px-3 py-1 rounded-full bg-white/5 text-[10px] font-bold text-gray-400">Base 100</div>
 </div>
 </div>
 ...
 <div className="bg-slate-900/40 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-2xl">
 ...
 <div className="mt-8 pt-6 flex items-center gap-6">
 ...
 <div className="mt-8 p-6 rounded-3xl bg-white/5 space-y-4">
