...
"{title}"
 ...
 <button 
 onClick={onForceSend}
 className="px-5 py-2.5 rounded-xl font-black text-gray-500 bg-white/5 hover:bg-indigo-500/10 hover:text-indigo-400 transition-all text-[10px] uppercase tracking-widest"
 >
 Aggiorna Ora
 </button>
 )}
