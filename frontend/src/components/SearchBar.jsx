    ...
    <div className="relative w-full max-w-md group" ref={dropdownRef}>
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-surface border border-border rounded-xl py-2 pl-10 pr-10 text-sm text-text placeholder-text-secondary/50 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all backdrop-blur-sm"
        />
        {loading ? (
          ...
          <div className="max-h-[320px] overflow-y-auto py-2">
            {results.map((result) => (
              ...
              >
                ...
                <div className="text-[10px] font-bold uppercase tracking-wider text-text-secondary bg-background px-2 py-0.5 rounded border border-border group-hover/item:border-primary/30 group-hover/item:text-text">
                  {result.type}
                </div>
              </button>
            ))}
          </div>
          <div className="px-4 py-2 bg-background border-t border-border text-[10px] text-text-secondary text-center uppercase tracking-widest">
