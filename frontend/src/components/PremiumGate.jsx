  ...
  return (
    <div className="relative group overflow-hidden rounded-3xl">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center p-6 bg-white/40 dark:bg-slate-900/40 backdrop-blur-[2px]">
        <div className="bg-surface/95 border border-border p-6 sm:p-8 rounded-3xl shadow-2xl text-center max-w-md transform transition-transform duration-300 scale-95 group-hover:scale-100">
          <div className="w-14 h-14 mx-auto bg-primary/10 rounded-2xl flex items-center justify-center mb-4 border border-primary/20 shadow-lg shadow-primary/10">
